...
abstract class MovieLocatorRepository {
  ...
  Future<Either<Failure, MovieEntity>> updateMovie(MovieEntity movie);
  ...
  Future<Either<Failure, TheaterEntity>> updateTheaterData(
      TheaterEntity entity);
  Future<Either<Failure, bool>> deleteTheaterData(String ref);
  Future<Either<Failure, bool>> deleteMovies(String ref);
