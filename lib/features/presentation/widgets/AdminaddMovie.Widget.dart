...
class AdminAddMovieWidget extends StatefulWidget {
  ...
  @override
  State<AdminAddMovieWidget> createState() => _AdminAddMovieWidgetState();
  //movieName : this.movieName, movieDes: this.movieDes, movieImage: this.movieImage);
}

class _AdminAddMovieWidgetState extends State<AdminAddMovieWidget> {
  @override
