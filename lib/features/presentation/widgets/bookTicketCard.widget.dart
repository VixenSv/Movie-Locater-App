...
//   BookTicketCardWidget({ 
//     Key? key,
//     this.onPressed, required this.movieEntity, required this.movieName,  required this.theaterclass, required this.seats, required this.showTimeList
//      }) : super(key: key);
