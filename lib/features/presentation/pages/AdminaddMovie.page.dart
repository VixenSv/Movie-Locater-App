...
class _AdminAddMoviePageState extends State<AdminAddMoviePage> {
  List<String> theaterList = ['oiechwoihc','loechwoce',];
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: [
                        ...
                        RedButtonWidget(onPressed: (){
                          setState(() {
                            addedList.add(new TheaterModel(theaterId: '', theaterName: this.selectedTheater, theaterImage: '', availbleClasses: [], theaterLocationLink: '', showEntityList: []));
                          });
                        }, label: 'Add theater')
                      ],
                    ),
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Column(
                        children: this.addedList.map((e) => MLAText(text: e.theaterName,)).toList(),
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                          ...
                          RedButtonWidget(
                              onPressed: () => {
                                context
                                    ...
                                    .add(AddMovieEvent(
                                  context: context,
                                  movieEntity: MovieEntity(movieId: '',movieImage: this.movieImageText,movieDescription: this.movieDescriptionText,movieName: this.movieNameText,theaterList: this.addedList,),
                                ))
                              },
                              label: 'Add Movie')
                        ],
