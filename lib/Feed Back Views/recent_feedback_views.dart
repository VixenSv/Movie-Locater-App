...
class _RecentsViewState extends State<RecentsView> {
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          await FirebaseFirestore.instance.collection('feedback').doc(obj.feedback_id.value).update({
                            'userid':"",
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child:const Center(
                            child: Text("Cancel",style: TextStyle(color: Colors.black,fontSize: 14,fontWeight: FontWeight.bold),),
                          ),
                        ),
                      )
                    ],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title:  Text("Recent Feedback",style: appbar_text,),
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                            onTap: (){
                                              FirebaseFirestore.instance.collection('feedback').doc(userdocument[i].id).delete();
