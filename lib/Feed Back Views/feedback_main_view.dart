...
class _FeedBackMainState extends State<FeedBackMain> {
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Center(child: Text("Thank You",style: dropdown_heading,)),
              const  SizedBox(height: 10,),
              Container(
                  // height: heightsize*0.05,
                  width: widthsize,
                  child: Text("Thank You For Sharing your Thoughts.\n We appreciate your Feedback",
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child:const Center(
                    child: Text("Ok",style: TextStyle(color: Colors.black,fontSize: 15,fontWeight: FontWeight.bold),),
                  ),
                ),
              )
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title:  Text("Feedback Screen",style: appbar_text,),
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text("Your Feedback is very Important For us",style: heading,),
              SizedBox(height: heightsize*0.01,),
              Container(
                height: heightsize*0.07,
                  width: widthsize*0.8,
                  child: Text("Please Select a below & let us know about your concern",textAlign: TextAlign.center,
                  style: sub_heading,
                  )),
             ...
             Container(
               ...
               child: Column(
                 ...
                 children: [
                   ...
                   SizedBox(height: 10,),
                   description_valid=="null"?SizedBox():Text(description_valid,style: TextStyle(color: Colors.red,fontSize: 12),),
                   SizedBox(height: 10,),
                 ],
               ),
             ),
             //Submit Button
              AuthButton(
                buttoncolor: description_valid=="null" && slected_feedback!=""?Color(0XFFC8E5F5):Color(0XFFC8E5F5).withOpacity(0.6),
                onTap: description_valid=="null" && slected_feedback!=""?() async {
